...
Page({
  ...
  backgroundPlay: function () {
    ...
    this.data.backgroundAudio.src = 'http://music.163.com/song/media/outer/url?id=1472945318.mp3'
    this.data.backgroundAudio.playList = [{
      poster: 'http://image.biaobaiju.com/uploads/20180803/23/1533309822-GCcDphRmqw.jpg',
      name: '普通disco1',
      author: '洛天依/言和1',
      src: 'http://music.163.com/song/media/outer/url?id=1472945318.mp3'
      ,
    },
    {
      ...
      name: '普通disco2',
      author: '洛天依/言和2',
      src: 'http://music.163.com/song/media/outer/url?id=1449741507.mp3'
    }];
  ...
  backgroundAudioPre: function () {
    this.data.backgroundAudio.onPrev()
  },
  backgroundAudioNext: function () {
    this.data.backgroundAudio.onNext()
  }
})